...
export default function AIBeautyArchitect({ onOpenBooking }) {
  ...
  return (
    <section id="architect" className="py-20 md:py-28 bg-[#0A0807] text-[#FBF3EC] relative border-b border-[#D4AF37]/25">
      <div ref={revealRef} className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 reveal-on-scroll">
        
        {/* Header */}
        <div className="text-center max-w-2xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#1A1412] border border-[#EE9A70]/50 text-[#EE9A70] text-[11px] font-futuristic uppercase tracking-[0.2em] font-semibold mb-3">
        ...
        <div className="bg-[#14100E] border border-[#D4AF37]/35 rounded-2xl shadow-2xl p-6 sm:p-10 futuristic-card">
          ...
          {!completed ? (
            <div>
              ...
              <div className="flex items-center justify-between mb-8 pb-4 border-b border-[#D4AF37]/20">
                <div className="flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-[#D4AF37] text-[#0A0807] flex items-center justify-center text-xs font-bold font-futuristic">
                    {step}
                  </span>
              ...
              {step === 1 && (
                <div className="space-y-4">
                  <p className="text-xs font-futuristic font-bold text-[#D4AF37] uppercase tracking-wider">Where will you be seen?</p>
                    ...
                    {occasionsList.map((item, idx) => (
                      <button
                        ...
                        className={`p-4 rounded-xl text-left border transition-all cursor-pointer ${
                          occasion === item.title 
                            ? 'bg-[#241B18] border-[#EE9A70] shadow-lg ring-1 ring-[#EE9A70]' 
                      ...
                      >
                        ...
                        <span className="text-xs text-[#D1C2BA] block font-sans">
                          {item.desc}
                        </span>
                      </button>
                    ))}
                  ...
                  <div className="pt-6 flex justify-end">
                    <button
                      onClick={() => setStep(2)}
                      className="inline-flex items-center gap-2 bg-[#D4AF37] text-[#0A0807] px-6 py-3 rounded-sm text-xs font-futuristic font-bold uppercase tracking-[0.15em] shadow-lg hover:bg-[#F3E5AB] transition-colors cursor-pointer"
                    >
              ...
              {step === 2 && (
                <div className="space-y-4">
                  <p className="text-xs font-futuristic font-bold text-[#D4AF37] uppercase tracking-wider">What is your current hair and skin state?</p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="pt-6 flex justify-between">
                    <button
                      onClick={() => setStep(1)}
                      className="px-5 py-2.5 rounded-sm border border-[#D4AF37]/40 text-xs font-futuristic font-medium text-[#FBF3EC] hover:bg-white/10 cursor-pointer"
                    >
                      Back
                    </button>
                    <button
              ...
              {step === 3 && (
                <div className="space-y-4">
                  <p className="text-xs font-futuristic font-bold text-[#D4AF37] uppercase tracking-wider">What is your dream reflection?</p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="pt-6 flex justify-between">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 bg-[#EE9A70] text-[#0A0807] px-7 py-3 rounded-sm text-xs font-futuristic font-bold uppercase tracking-[0.15em] shadow-xl hover:bg-[#F6C6A8] transition-colors cursor-pointer"
                    >
                      {isAnalyzing ? (
                        <>
                          <span className="w-3.5 h-3.5 border-2 border-[#0A0807] border-t-transparent rounded-full animate-spin"></span>
            ...
            <div className="space-y-6 animate-in fade-in duration-300">
              ...
              <div className="flex flex-wrap items-center justify-between pb-4 border-b border-[#D4AF37]/25 gap-2">
                ...
                <button
                  onClick={handleReset}
                  className="inline-flex items-center gap-1.5 text-xs text-[#D1C2BA] hover:text-[#FBF3EC] border border-[#D4AF37]/30 px-3 py-1.5 rounded cursor-pointer font-futuristic"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center bg-[#1A1412] p-5 sm:p-6 rounded-xl border border-[#D4AF37]/30">
                ...
                <div className="md:col-span-5 flex items-center gap-4 border-b md:border-b-0 md:border-r border-[#D4AF37]/25 pb-4 md:pb-0 md:pr-4">
                  ...
                  />
                  <div>
                    <span className="text-[10px] uppercase font-futuristic tracking-wider text-[#D4AF37] font-semibold block">
                    ...
                    <span className="text-[10px] text-[#EE9A70] font-futuristic font-semibold mt-1 block">
                ...
                <div className="md:col-span-7 space-y-2 text-xs">
                  <div>
                    <span className="text-[#D4AF37] font-futuristic font-bold block uppercase text-[10px]">Custom Chemical Formula:</span>
                    <p className="text-[#FBF3EC] font-medium font-sans">{rec.formula}</p>
                  </div>
                  <div>
                    <span className="text-[#D4AF37] font-futuristic font-bold block uppercase text-[10px]">Protocol &amp; Diagnostics:</span>
                    <p className="text-[#D1C2BA] font-sans">{rec.protocol}</p>
                  </div>
                  <div className="flex items-center gap-4 pt-2 text-[#D1C2BA]">
                    <span className="flex items-center gap-1 font-futuristic"><Clock className="w-3.5 h-3.5 text-[#D4AF37]" /> {rec.duration}</span>
                    <span className="font-futuristic font-bold text-sm text-[#F3E5AB]">{rec.price}</span>
                  </div>
                </div>
              ...
              <div className="pt-2 flex flex-wrap items-center justify-between gap-4">
                <p className="text-xs text-[#D1C2BA]/70 italic font-sans">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 bg-[#D4AF37] hover:bg-[#F3E5AB] text-[#0A0807] px-7 py-3.5 rounded-sm text-xs font-futuristic font-bold uppercase tracking-[0.15em] shadow-xl border border-[#D4AF37]/50 cursor-pointer"
                >
